...
3. The deployment can access gptGO Marketplace when installing from Marketplace.
...
1. Open **Tools** in the gptGO workspace.
...
4. Wait for gptGO to upload and inspect the packages.
