...
description: SiliconCloud integration example for gptGO
---
...
If you want to quickly try open source models or get started with gptGO without applying for API keys from multiple providers, SiliconCloud is a great option for a fast start.

If you plan to self-host models and gptGO in the future, you can use SiliconCloud for initial testing and validation, then proceed with hardware procurement later — reducing POC time and cost.
