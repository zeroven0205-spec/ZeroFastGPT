---
title: 'V4.15.0-beta1'
description: 'gptGO V4.15.0-beta1 Release Notes'
...
- Update the gptGO-app (gptGO main service) image tag to v4.15.0-beta1.
- Update the gptGO-pro (gptGO commercial edition) image tag to v4.15.0-beta1.
- Update the gptGO-plugin image tag to v0.6.2.
...
4. Added DingTalk Dataset integration for third-party Datasets (beta; rich-text retrieval has known issues).
...
5. Strengthened SSRF protection for third-party Dataset requests.
...
2. Fixed missing charset information when previewing or downloading Dataset source files with text responses.
