---
title: 'V4.15.0-beta4'
description: 'gptGO V4.15.0-beta4 更新说明'
...
- 更新 gptGO-app(gptGO 主服务) 镜像 tag: v4.15.0-beta4
- 更新 gptGO-pro(gptGO 商业版) 镜像 tag: v4.15.0-beta4
- 更新 gptGO-plugin 镜像 tag: v1.0.0-beta2
...
也可以打开插件市场逐个下载，正式版之前，插件市场地址为: [https://github.com/zeroven0205-spec/](https://github.com/zeroven0205-spec/)
