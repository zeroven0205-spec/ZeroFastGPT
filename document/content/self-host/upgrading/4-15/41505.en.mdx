---
title: 'V4.15.0-beta5'
description: 'gptGO V4.15.0-beta5 Release Notes'
...
- Update the gptGO-app (gptGO main service) image tag to v4.15.0-beta5.
- Update the gptGO-pro (gptGO commercial edition) image tag to v4.15.0-beta5.
- Update the gptGO-plugin image tag to v1.0.0-beta5.
- Update the aiproxy image tag to v0.6.2.

If Agent Sandbox is enabled, also update the following images:

- Add the gptGO-agent-sandbox-proxy image with tag v0.2.0-beta2.
- Update the gptGO-agent-sandbox image tag to v0.2.0-beta2.
...
6. When a tool returns an empty response, gptGO now automatically fills in `"none"` to avoid errors from some models.
