---
title: 'V4.15.0-beta2'
description: 'gptGO V4.15.0-beta2 Release Notes'
...
- Update the gptGO-app (gptGO main service) image tag to v4.15.0-beta2
- Update the gptGO-pro (gptGO commercial edition) image tag to v4.15.0-beta2

If you use OpenSandbox, update the following images:

- Update the gptGO-agent-sandbox image tag to v0.2.0
- Update the gptGO-agent-volume-manager image tag to v0.2.0
