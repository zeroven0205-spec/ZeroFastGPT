---
title: 'V4.15.0-beta5'
description: 'gptGO V4.15.0-beta5 更新说明'
...
- 更新 gptGO-app(gptGO 主服务) 镜像 tag: v4.15.0-beta5
- 更新 gptGO-pro(gptGO 商业版) 镜像 tag: v4.15.0-beta5
- 更新 gptGO-plugin 镜像 tag: v1.0.0-beta5
- 更新 aiproxy 镜像 tag: v0.6.2

如果启用 Agent Sandbox，需同步更新下面镜像：

- 新增 gptGO-agent-sandbox-proxy 镜像 tag: v0.2.0-beta2
- 更新 gptGO-agent-sandbox 镜像 tag: v0.2.0-beta2
