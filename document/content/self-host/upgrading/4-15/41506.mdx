---
title: 'V4.15.0-beta6'
description: 'gptGO V4.15.0-beta6 更新说明'
...
- 更新 gptGO-app(gptGO 主服务) 镜像 tag: v4.15.0-beta6
- 更新 gptGO-pro(gptGO 商业版) 镜像 tag: v4.15.0-beta6
- 更新 gptGO-plugin 镜像 tag: v1.0.0-beta6
- 更新 aiproxy 镜像 tag: v0.6.2

如果启用 Agent Sandbox，需同步更新下面镜像：

- 更新 gptGO-agent-sandbox-proxy 镜像 tag: v0.2.0-beta3
- 更新 gptGO-agent-sandbox 镜像 tag: v0.2.0-beta3
