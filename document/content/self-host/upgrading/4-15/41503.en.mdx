---
title: 'V4.15.0-beta3'
description: 'gptGO V4.15.0-beta3 Release Notes'
releaseTime: '2026-05-28'
upgradeTags:
  - CONFIG
---
...
- Update the gptGO-app (gptGO main service) image tag to v4.15.0-beta3.
- Update the gptGO-pro (gptGO commercial edition) image tag to v4.15.0-beta3.
- Update the gptGO-code-sandbox image tag to v4.15.0-beta3.
...
1. Improved styles for Skill dialogs.
...
2. Fixed cases where Dataset data chunking could produce oversized chunks when code blocks were present.
