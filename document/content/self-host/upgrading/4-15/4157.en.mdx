---
title: 'V4.15.7'
description: 'gptGO V4.15.7 Release Notes'
...
- Update the gptGO-app (gptGO core service) image tag to v4.15.7.
- Update the gptGO-pro (gptGO commercial edition) image tag to v4.15.7.
