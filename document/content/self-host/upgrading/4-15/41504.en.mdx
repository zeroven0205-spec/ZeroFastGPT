---
title: 'V4.15.0-beta4'
description: 'gptGO V4.15.0-beta4 Release Notes'
...
- Update the gptGO-app (gptGO main service) image tag to v4.15.0-beta4.
- Update the gptGO-pro (gptGO commercial edition) image tag to v4.15.0-beta4.
- Update the gptGO-plugin image tag to v1.0.0-beta2.
- Update the aiproxy image tag to v0.6.1.

### 3. Reinstall System Tools

1. Download the [zip package](https://github.com/zeroven0205-spec/) for all system tools.
...
You can also download tools one by one from the plugin marketplace. Before the stable release, the marketplace URL is: [https://github.com/zeroven0205-spec/](https://github.com/zeroven0205-spec/)

## 🚀 New Features

1. Reworked the plugin system architecture.
2. Reworked the chatbox UI.
3. Added virtual list rendering for apps and Datasets.
...
6. Apps now show a graceful prompt during orchestration when a Dataset has been deleted.
...
2. Fixed a potential unauthorized access risk in indexing APIs.
