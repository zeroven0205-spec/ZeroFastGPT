---
title: 'V4.13.2'
description: 'gptGO V4.13.2 Release Notes'
...
- Update gptGO image tag: v4.13.2
- Update gptGO commercial edition image tag: v4.13.2
- Update gptGO-plugin image tag: v0.2.4
- mcp_server: no update needed
- Sandbox: no update needed
- AIProxy: no update needed

### 2. Add gptGO/FastGPT-pro Environment Variables
...
### 3. Fix gptGO-plugin Environment Variables
...
1. HTTP Toolkit now supports manual creation mode.
