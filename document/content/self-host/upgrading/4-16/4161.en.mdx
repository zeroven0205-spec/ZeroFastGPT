---
title: 'V4.16.1'
description: 'gptGO V4.16.1 release notes'
...
- Update the fastgpt-app (gptGO core service) image tag to `v4.16.1`
- Update the fastgpt-pro (gptGO commercial edition) image tag to `v4.16.1`
