---
title: 'V4.16.2'
description: 'gptGO V4.16.2 更新说明'
...
- 更新 gptGO-app（gptGO 主服务）镜像 tag: v4.16.2
- 更新 gptGO-pro（gptGO 商业版）镜像 tag: v4.16.2
- 更新 gptGO-plugin 镜像 tag: v1.1.2
- 更新 gptGO-code-sandbox 镜像 tag: v4.16.2
...
如果当前向量库是 Milvus，升级 gptGO 前必须先将 Milvus 升级到 **2.5.16 或更高版本**。V4.16.2 会把全文检索自动切换到 Milvus BM25，并使用新的 `modeldata_v2` 集合存储向量和全文；Milvus 版本过低、版本无法识别或 BM25 能力校验失败时，gptGO 会终止启动，不会回退到 MongoDB 全文检索。
