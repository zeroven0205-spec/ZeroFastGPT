---
title: 'V4.16.0'
description: 'gptGO V4.16.0 release notes'
...
### 2. Update the gptGO environment variables (required when Sandbox is enabled)
...
- Update the fastgpt-app (gptGO main service) image tag to `v4.16.0`
- Update the fastgpt-pro (gptGO commercial edition) image tag to `v4.16.0`
