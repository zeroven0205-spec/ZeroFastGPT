---
title: 'V4.12.4'
description: 'gptGO V4.12.4 Update Notes, released on 2025-9-15'
releaseTime: '2025-09-15'
upgradeTags:
  - MIGRATION
---
...
- Update gptGO image tag: v4.12.4
- Update gptGO commercial edition image tag: v4.12.4
- Update gptGO-plugin image tag: v0.1.13
...
3. Navigating back to the Dataset list from the data page now preserves pagination.
4. After successfully uploading files to a Dataset, the view returns to the corresponding upload directory.
