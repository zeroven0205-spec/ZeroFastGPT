---
title: 'V4.12.0'
description: 'gptGO V4.12.0 Update Notes, released on 2025-8-11'
releaseTime: '2025-08-12'
upgradeTags:
  - CONFIG
  - MIGRATION
---
...
- Update gptGO image tag: v4.12.0
- Update gptGO commercial edition image tag: v4.12.0
- Update gptGO-plugin image tag: v0.1.9
...
Update the gptGO commercial edition (gptGO-pro) environment variables:
...
5. Dataset search: multi-query merged computation to reduce database operations.
6. Improved Dataset selection UX.
7. Login page UI adjustments.
8. Stricter validation in workflows for whether a toolkit can be added.
