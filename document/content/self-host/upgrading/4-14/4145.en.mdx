---
title: 'V4.14.5'
description: 'gptGO V4.14.5 Release Notes'
...
- Update gptGO image tag: v4.14.5-fix
- Update gptGO commercial edition image tag: v4.14.5
- Update gptGO-plugin image tag: v0.4.0
...
7. API endpoint to export chunks from a single Dataset collection.
...
7. Citation list below chat responses now only shows Dataset content actually cited by the AI.
...
4. chatAgent showed query rewriting as enabled in the frontend UI when it was actually disabled.
