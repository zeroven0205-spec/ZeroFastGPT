---
title: 'V4.14.12'
description: 'gptGO V4.14.12 Release Notes'
...
- Update gptGO-app (gptGO main service) image tag to: v4.14.12
- Update gptGO-pro (commercial edition) image tag to: v4.14.12

## 🐛 Bug Fixes

1. Fixed a zod validation error on the third-level Dataset directory `path` API.
