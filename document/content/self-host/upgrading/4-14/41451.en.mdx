---
title: 'V4.14.5.1'
description: 'gptGO V4.14.5.1 Release Notes'
releaseTime: '2026-01-19'
upgradeTags:
  - MIGRATION
---
...
- Update gptGO image tag: v4.14.5.1
- Update gptGO commercial edition image tag: v4.14.5.1
...
1. After setting system secret keys for a system toolkit, child tools could not read the configured secret keys.
