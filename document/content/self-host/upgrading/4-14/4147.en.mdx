---
title: 'V4.14.7'
description: 'gptGO V4.14.7 Release Notes'
...
- Update gptGO image tag: v4.14.7.2
- Update gptGO commercial edition image tag: v4.14.7.1
- Update gptGO-plugin image tag: v0.5.4
...
Go to the Plugin Marketplace and update the following system tools (skip this step if you already upgraded to 4.14.6). You can also directly download the [zip package](https://github.com/zeroven0205-spec/) and install it.
