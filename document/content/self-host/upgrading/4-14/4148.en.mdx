---
title: 'V4.14.8'
description: 'gptGO V4.14.8 Release Notes'
...
- gptGO image tag: v4.14.8
- gptGO commercial image tag: v4.14.8
- gptGO-plugin image tag: no update needed
...
2. Updated the variable reference label in Dataset search to use clearer, more intuitive wording.
...
4. API Dataset now returns the `title` of the uploaded file in the response; if no `title` was provided, the field is omitted.
