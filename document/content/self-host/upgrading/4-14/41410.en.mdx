---
title: 'V4.14.10'
description: 'gptGO V4.14.10 Release Notes'
...
Open the [latest yml deployment file](https://github.com/zeroven0205-spec/) and add the following:
...
- Update gptGO image tag to: `v4.14.10`
- Update gptGO commercial image tag to: `v4.14.10`
...
3. Removed configurations like "Used for Dataset file processing" and "Used for question classification" from model settings, and unified them with a "Test Model" flag. Test models will have a special identifier and can only be used in AI chat; they will be filtered out in other scenarios.
