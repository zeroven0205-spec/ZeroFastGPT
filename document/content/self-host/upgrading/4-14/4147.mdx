---
title: 'V4.14.7'
description: 'gptGO V4.14.7 更新说明'
...
- 更新 gptGO 镜像 tag: v4.14.7.2
- 更新 gptGO 商业版镜像 tag: v4.14.7.1
- 更新 gptGO-plugin 镜像 tag: v0.5.4
...
前往插件市场更新以下几个系统工具（如果 4.14.6 升级了，这里可以跳过）。可以直接下载 [zip 包](https://github.com/zeroven0205-spec/)直接安装。
...
7. 对话日志列表，精准的过滤使用者。
8. 依赖预检查，启动项目时进行 infra/子服务有效性检测，便于准确定位不可用的服务。
