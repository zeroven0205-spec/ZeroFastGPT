---
title: 'V4.14.2'
description: 'gptGO V4.14.2 Release Notes'
...
- Update gptGO image tag: v4.14.2
- Update gptGO commercial edition image tag: v4.14.2
- Update gptGO-plugin image tag: v0.3.2
...
3. Quick Dataset creation from the Agent editor page.
...
7. Added: WeChat Official Account toolkit.
