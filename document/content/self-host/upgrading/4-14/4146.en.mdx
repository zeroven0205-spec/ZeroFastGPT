---
title: 'V4.14.6'
description: 'gptGO V4.14.6 Release Notes'
...
- Update gptGO image tag: v4.14.6.1
- Update gptGO commercial edition image tag: v4.14.6
- Update gptGO-plugin image tag: v0.5.2
...
2. WeCom-related plugins: Get WeCom enterprise access_token; WeCom smart table toolkit.
