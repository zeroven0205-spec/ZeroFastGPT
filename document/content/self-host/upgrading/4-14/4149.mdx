---
title: 'V4.14.9'
description: 'gptGO V4.14.9 更新说明'
...
1. 修改 gptGO 环境变量：SANDBOX_URL 和 SANDBOX_TOKEN，改名成 CODE_SANDBOX_URL 和 CODE_SANDBOX_TOKEN：
...
2. 默认关闭内网安全检查，如需开启，需设置环境变量 `CHECK_INTERNAL_IP=true`（gptGO,fastgpt-pro,fastgpt-sandbox 通用变量）

### 2. 更新镜像

- 更新 gptGO 镜像 tag: v4.14.9.5
- 更新 gptGO 商业版镜像 tag: v4.14.9.5
- 更新 gptGO-plugin 镜像 tag: v0.5.5
- mcp_server 无需更新
