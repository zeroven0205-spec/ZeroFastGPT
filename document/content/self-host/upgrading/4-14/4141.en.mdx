---
title: 'V4.14.1'
description: 'gptGO V4.14.1 Release Notes'
...
- Update gptGO image tag: v4.14.1
- Update gptGO commercial edition image tag: v4.14.1
- Update gptGO-plugin image tag: v0.3.1
...
1. New Studio interaction. The original "Plugin" has been renamed to "Workflow Tool" and moved under the My Tools category.
2. Workflows now provide a "Continue" button after running out of points, so you don't have to start over.
