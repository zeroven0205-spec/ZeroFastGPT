---
title: 'V4.14.3'
description: 'gptGO V4.14.3 Release Notes'
releaseTime: '2025-11-27'
upgradeTags:
  - MIGRATION
---
...
- Update gptGO image tag: v4.14.3
- Update gptGO commercial edition image tag: v4.14.3
- Update gptGO-plugin image tag: v0.3.3
...
This will migrate all Dataset files from MongoDB GridFS to S3, including text Collections and image Collections, but not images extracted from documents (e.g., .docx files).

## New Features

1. Dataset files migrated to S3 (all file-related functionality has been migrated).
...
2. WeChat Official Account toolkit: now allows uploading multiple documents to the draft box at once.
