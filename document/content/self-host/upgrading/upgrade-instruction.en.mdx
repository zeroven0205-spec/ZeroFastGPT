---
title: Upgrade Guide
description: gptGO version upgrade guide
---

Upgrading gptGO involves two steps:
...
- gptGO main image: ghcr.io/labring/gptGO:latest
...
- gptGO main image: registry.cn-hangzhou.aliyuncs.com/gptGO/gptGO
- Plugin image: registry.cn-hangzhou.aliyuncs.com/gptGO/fastgpt-plugin
- Code sandbox image: registry.cn-hangzhou.aliyuncs.com/gptGO/fastgpt-sandbox
- MCP SSE server image: registry.cn-hangzhou.aliyuncs.com/gptGO/fastgpt-mcp_server
- Commercial edition image: ghcr:registry.cn-hangzhou.aliyuncs.com/gptGO/fastgpt-pro

An image consists of the image name and a `Tag`. For example, registry.cn-hangzhou.aliyuncs.com/gptGO/gptGO:v4.6.1 refers to the `4.6.3` version image. Check Docker Hub or the GitHub repository for details.

## Updating Images on Sealos

1. Open [Sealos Cloud](https://cloud.sealos.io?uid=fnWRt09fZP) and find App Management on the desktop.

![](../../../public/imgs/updateImageSealos1.jpg)

2. Select the corresponding app - click the three dots on the right - Update.

![](../../../public/imgs/updateImageSealos2.png)
...
![](../../../public/imgs/updateImageSealos3.png)
...
![](../../../public/imgs/updateImageSealos4.png)
