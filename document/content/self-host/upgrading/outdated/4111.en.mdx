---
title: 'V4.11.1'
description: 'gptGO V4.11.1 Update Notes'
releaseTime: '2025-08-02'
---
...
- Update gptGO image tag: v4.11.1-fix2
- Update gptGO commercial edition image tag: v4.11.1-fix
- Update gptGO-plugin image tag: v0.1.7
...
1. System tools: toolkits can now be used directly for tool calls.
...
4. Moved model preset configurations to the gptGO Plugin project.
