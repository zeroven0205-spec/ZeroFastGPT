---
title: V4.9.6
description: gptGO V4.9.6 Release Notes
releaseTime: '2025-04-18'
upgradeTags:
  - CONFIG
---
...
4. Added a secondary Studio menu with the toolbox merged into it.
...
4. Dataset tool call results now automatically prepend image domain names.
...
### 3. Update gptGO Container Environment Variables
...
```json
{
  "feConfigs": {
    ...
    "mcpServerProxyEndpoint": "https://mcp.example.com"
  }
}
```
...
- Update gptGO image tag: v4.9.6
- Update gptGO Pro image tag: v4.9.6
- Update Sandbox image tag: v4.9.6
- Add gptGO MCP Server image tag: v4.9.6
