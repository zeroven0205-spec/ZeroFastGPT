---
title: V4.8.13
description: gptGO V4.8.13 Release Notes
...
- Update the gptGO image tag to v4.8.13-fix
- Update the gptGO commercial edition image tag to v4.8.13-fix (gptGO-pro image)
- Sandbox image update is optional

### 3. Add environment variables

- Add the environment variable `FE_DOMAIN=http://xx.com` to both the gptGO and fastgpt-pro images. Set the value to the gptGO frontend access URL (do not include a trailing `/`). This automatically prepends the domain to relative file paths.
...
11. Improved - Better error messages for Dataset file uploads.
12. Improved - Full-text search query rewriting, eliminating one subquery.
