---
title: V4.8.6
description: gptGO V4.8.6 Release Notes
...
- Update the gptGO image tag to v4.8.6
- Update the gptGO-sandbox image tag to v4.8.6
- Update the commercial edition image tag to v4.8.6

### 3. Run Initialization

From any terminal, send 1 HTTP request. Replace `{{rootkey}}` with the `rootkey` from your environment variables, and `{{host}}` with your **gptGO domain**.
