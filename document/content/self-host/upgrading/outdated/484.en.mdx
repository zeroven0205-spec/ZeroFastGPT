---
title: V4.8.4
description: gptGO V4.8.4 Release Notes
...
- Update the gptGO image tag to v4.8.4
- Update the gptGO-sandbox image tag to v4.8.4 (optional, no changes)
- Update the commercial edition image tag to v4.8.4

### 2. Commercial Edition Initialization

From any terminal, send 1 HTTP request. Replace `{{rootkey}}` with the `rootkey` from your environment variables, and `{{host}}` with your **gptGO commercial edition domain**.
