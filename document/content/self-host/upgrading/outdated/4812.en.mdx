---
title: V4.8.12
description: gptGO V4.8.12 Release Notes
...
- Update the gptGO image tag to v4.8.12-fix
- Update the gptGO admin image tag to v4.8.12 (gptGO-pro image)
...
This initializes member group data for apps and Datasets.
...
12. New - Apps and Datasets support member group permission configuration.
