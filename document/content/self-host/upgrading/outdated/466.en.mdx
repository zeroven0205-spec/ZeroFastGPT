---
title: V4.6.6
description: gptGO V4.6.6
releaseTime: '2024-01-08'
upgradeTags:
  - CONFIG
---
...
3. The `FeConfig` section has been removed from the configuration file. You can now configure it directly through the commercial edition's web interface. All gptGO parameters and models can be configured from the commercial edition dashboard — no need to modify `config.json` anymore.

## V4.6.6 Release Notes

1. Check out the [gptGO 2024 RoadMap](https://github.com/zeroven0205-spec/).
...
8. Fixed - Link-based Collections not saving selectors, causing syncs to run without them.
