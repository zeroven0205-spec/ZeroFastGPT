---
title: V4.9.8
description: gptGO V4.9.8 Release Notes
releaseTime: '2025-05-13'
---
...
- Update gptGO image tag: v4.9.8
- Update gptGO Pro image tag: v4.9.8
...
4. Yuque Dataset now supports setting a root directory.
...
7. Admin panel now supports configuring visibility of publishing channels and third-party datasets.
...
1. App list / Dataset list: incorrect permission display for delete row actions.
2. Opening Dataset search parameters automatically enabling the rerank option.
