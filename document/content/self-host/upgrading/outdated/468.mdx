...
3. 优化 - 内容补全。将内容补全内置到【知识库搜索】中，并实现了一次内容补全，即可完成“指代消除”和“问题扩展”。gptGO 知识库搜索详细流程可查看：[知识库搜索介绍](../../../guide/build/workflow/nodes/dataset_search.mdx)
