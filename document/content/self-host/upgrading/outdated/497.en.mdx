---
title: V4.9.7
description: gptGO V4.9.7 Release Notes
...
- Update gptGO image tag: v4.9.7-fix2
- Update gptGO Pro image tag: v4.9.7
...
1. Dataset answers now include citations at the end of each referenced paragraph.
...
8. Debugging the Dataset search node showing "no permission" errors.
...
11. Dataset collection metadata filtering: same-named tags across different datasets returning no results when using `$and` filters.
