---
title: V4.8.16
description: gptGO V4.8.16 更新说明
...
- 更新 gptGO 镜像 tag: v4.8.16
- 更新 gptGO-pro 商业版镜像 tag: v4.8.16
...
5. 新增 - 商业版支持钉钉 SSO 登录配置。[点击查看教程](../../../guide/admin/sso.mdx#钉钉)
6. 新增 - 商业版支持飞书和语雀知识库导入。[点击查看教程](../../../guide/dataset/third-party/lark_dataset.mdx)
...
20. 修复 - 部分模板市场模板
21. 修复 - 设置 NEXT_PUBLIC_BASE_URL 时，图片文件读取 URL 不正确
