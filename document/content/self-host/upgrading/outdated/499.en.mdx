---
title: V4.9.9
description: gptGO V4.9.9 Release Notes
...
Pro edition users can contact the gptGO team for a license replacement plan. After replacement, you can upgrade the system directly — the admin panel will prompt you to enter the new license.

### 3. Update Image Tags

- Update gptGO image tag: v4.9.9
- Update gptGO Pro image tag: v4.9.9
