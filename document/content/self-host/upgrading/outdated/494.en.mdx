---
title: V4.9.4
description: gptGO V4.9.4 Release Notes
...
|                                                |                                                |                                                |
| ---------------------------------------------- | ---------------------------------------------- | ---------------------------------------------- |
| ![](../../../../public/imgs/sealos-redis1.png) | ![](../../../../public/imgs/sealos-redis2.png) | ![](../../../../public/imgs/sealos-redis3.png) |

### 3. Update Image Tags

- Update gptGO image tag: v4.9.4
- Update gptGO Pro image tag: v4.9.4
