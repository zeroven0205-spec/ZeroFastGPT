...
gptGO workflow V2 上线，支持更加简洁的工作流模式。
...
1. 重构 - 工作流
2. 新增 - 判断器。支持 if elseIf else 判断。@newfish-cmyk（preview 版本的 if else 节点需要删除重建）
...
8. 新增 - 分享链接发送对话前 hook https://github.com/zeroven0205-spec/ @gaord
...
15. 优化 - 工具调用支持指定字段数据类型（string, boolean, number）https://github.com/zeroven0205-spec/
16. 优化 - completions 接口 size 限制 https://github.com/zeroven0205-spec/
17. 优化 - Node.js API 中间件。优化 API 端代码。@c121914yu
18. 优化 - 对话记录保持为偶数进行截取，避免部分模型不支持奇数的历史记录，最大长度增加到 50 轮。https://github.com/zeroven0205-spec/
19. 优化 - HTTP 节点错误后终止进程 https://github.com/zeroven0205-spec/
20. 修复 - 工具调用时候，name 不能是数字开头（随机数有概率数字开头）@c121914yu
21. 修复 - 分享链接，query 全局变量会被缓存。@c121914yu
22. 修复 - 工具调用字段兼容。https://github.com/zeroven0205-spec/
23. 修复 - HTTP 模块 URL 光标问题 https://github.com/zeroven0205-spec/ @maquannene
