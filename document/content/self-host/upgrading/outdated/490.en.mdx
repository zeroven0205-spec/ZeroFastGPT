---
title: V4.9.0
description: gptGO V4.9.0 Release Notes
...
- Update gptGO image tag: v4.9.0
- Update gptGO Pro image tag: v4.9.0
- Sandbox image: no update required
- Update PG container to v0.8.0-pg15. See the [latest yml](https://github.com/zeroven0205-spec/)
...
#### 2. Add gptGO Environment Variables:

Modify the environment variables for the gptGO container in the yml file:
...
Run `docker-compose down` to stop services, then `docker-compose up -d` to start them. This will add the `aiproxy` service and update gptGO's configuration.
...
#### 5. Verify AI Proxy is Running in gptGO
...
### 4. Run the gptGO Upgrade Script
