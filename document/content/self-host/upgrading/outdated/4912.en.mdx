---
title: V4.9.12
description: gptGO V4.9.12 Release Notes
releaseTime: '2025-06-16'
upgradeTags:
  - CONFIG
---
...
- Update gptGO image tag: v4.9.12
- Update gptGO Pro image tag: v4.9.12
...
5. Pro edition supports LLM-based automatic chunk-boundary detection during Dataset chunking.
...
2. Backend now fully computes Dataset chunk parameters to prevent default values from being incorrectly applied in auto mode.
...
7. Deleting Dataset files no longer fails if the file doesn't exist.
...
5. Image TTL field not being cleared in Dataset documents, causing images to expire.
