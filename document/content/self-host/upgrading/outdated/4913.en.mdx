---
title: V4.9.13
description: gptGO V4.9.13 Release Notes
...
- Update gptGO image tag: v4.9.13
- Update gptGO Pro image tag: v4.9.13
...
2. Dataset collection search now supports nested search.
...
4. Manually updating Dataset indexes incorrectly deleting old indexes, causing manual indexes to become ineffective.
