---
title: V4.8.17
description: gptGO V4.8.17 Release Notes
...
- Update the gptGO image tag to v4.8.17-fix-title
- Update the gptGO-pro commercial edition image tag to v4.8.17
...
6. New - Search test API supports query rewriting.
...
9. Improved - Dataset search parameters: sliders now support input mode for more precise control.
