---
title: V4.8.23
description: gptGO V4.8.23 Release Notes
releaseTime: '2025-02-27'
upgradeTags:
  - MIGRATION
---
...
- Update the gptGO image tag to v4.8.23-fix
- Update the gptGO-pro commercial edition image tag to v4.8.23-fix
...
The script cleans up Dataset dirty data, primarily redundant full-text indexes.

## New Features

1. Added default "Dataset text understanding model" configuration.
...
5. Full-text index not deleted when removing a single Dataset data entry.
