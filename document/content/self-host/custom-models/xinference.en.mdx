...
## Integrate Local Models with gptGO

Add the qwen-chat model to the `llmModels` section of gptGO's `config.json`:
...
Restart gptGO to select the Qwen model in app configuration:

##

- Reference: [gptGO + Xinference: One-Stop Local LLM Private Deployment and Application Development](https://github.com/zeroven0205-spec/)
