---
title: Integrating the bge-rerank Rerank Model
description: Integrating the bge-rerank Rerank model with gptGO
---
...
1. [https://github.com/zeroven0205-spec/](https://github.com/zeroven0205-spec/)
2. [https://github.com/zeroven0205-spec/](https://github.com/zeroven0205-spec/)
3. [https://github.com/zeroven0205-spec/](https://github.com/zeroven0205-spec/)
...
1. registry.cn-hangzhou.aliyuncs.com/gptGO/bge-rerank-base:v0.1 (4 GB+)
2. registry.cn-hangzhou.aliyuncs.com/gptGO/bge-rerank-large:v0.1 (5 GB+)
3. registry.cn-hangzhou.aliyuncs.com/gptGO/bge-rerank-v2-m3:v0.1 (5 GB+)
...
## Integrate with gptGO

1. Open the gptGO model configuration and add a new Rerank model.
...
![alt text](../../../public/imgs/image-102.png)

## FAQ

### 403 Error

The custom request token in gptGO does not match the ACCESS_TOKEN environment variable.
