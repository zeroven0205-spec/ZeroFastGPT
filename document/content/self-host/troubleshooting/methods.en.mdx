...
description: gptGO Self-Hosting Common Troubleshooting Methods
---

## 1. Troubleshooting Methods

You can first look for [Issue](https://github.com/zeroven0205-spec/), or raise a new Issue. For private deployment errors, be sure to provide detailed operation steps, logs, and screenshots, otherwise it is difficult to troubleshoot.
