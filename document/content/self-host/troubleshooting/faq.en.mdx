...
description: gptGO Self-Hosting General Troubleshooting
---
...
Or gptGO cannot request OneAPI (not in the same network).

---

### How to change the root password

Modify the `DEFAULT_ROOT_PSW` environment variable, and then restart gptGO.
