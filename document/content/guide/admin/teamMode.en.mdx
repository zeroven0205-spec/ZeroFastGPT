---
title: Team Mode
description: gptGO Team Mode Documentation
---
...
When system configuration is complete and sync mode is enabled, members from external member systems are automatically synced to gptGO.
