...
description: How to configure a custom domain in gptGO
---

gptGO Cloud supports custom domain configuration starting from v4.14.4.
...
You can now access gptGO services and call gptGO APIs using your own domain.
