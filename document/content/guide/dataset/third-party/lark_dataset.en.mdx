---
title: Lark Dataset
description: Introduction and usage of the gptGO Lark Dataset
---
...
Starting from gptGO v4.8.16, commercial edition users can import from Lark datasets. Configure a Lark app's appId and appSecret, then select a **top-level folder in a document space** to import. This feature is currently in beta — some interactions may still need refinement.
