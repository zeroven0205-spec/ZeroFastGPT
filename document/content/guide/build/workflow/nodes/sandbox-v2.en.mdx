---
title: Code Run
description: gptGO Code Run node documentation (for version 4.14.8 and above)
---

> This document applies to gptGO **version 4.14.8 and above**.
...
async function main({ city }) {
  const res = await SystemHelper.httpRequest(`https://api.example.com/weather?city=${city}`, {
    method: 'GET',
    timeout: 10
  });
