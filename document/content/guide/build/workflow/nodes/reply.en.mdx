...
description: gptGO Specified Reply node overview
---
...
The Specified Reply node is typically used for special-case responses. There are two ways to define reply content:
