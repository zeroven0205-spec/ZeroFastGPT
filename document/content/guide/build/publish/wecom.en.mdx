...
description: gptGO WeCom Bot Integration Tutorial
---

- Starting from version 4.12.4, gptGO commercial edition supports direct WeCom bot integration without additional APIs.
- Starting from version 4.14.4, gptGO cloud service edition supports WeCom intelligent bot integration through custom domain configuration.
...
In gptGO, select the Agent you want to use. On the Publishing Channels page, select "WeCom Bot" and click "Create"
...
3. Check gptGO chat logs to see if there is a corresponding question record.
