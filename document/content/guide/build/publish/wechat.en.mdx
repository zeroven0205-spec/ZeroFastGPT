...
description: How to integrate gptGO with a WeChat personal account
---

## 1. Create a Publishing Channel

Open your gptGO Agent, click the tab at the top to switch to **Publishing Channels**, select **WeChat Personal Account**, and click **Create**.
