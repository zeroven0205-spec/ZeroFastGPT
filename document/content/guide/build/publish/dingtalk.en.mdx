...
description: gptGO DingTalk Bot Integration Tutorial
---

Starting from version 4.8.16, gptGO commercial edition supports direct DingTalk bot integration without additional APIs.
...
## 2. Add a Publishing Channel in gptGO

In gptGO, select the app you want to integrate. On the **Publishing Channels** page, create a new DingTalk bot publishing channel.
...
Click the **Bot** capability on the left sidebar, then set the **Message Receiving Mode** at the bottom to **HTTP Mode**, and paste the gptGO callback address you copied earlier as the message receiving address.
