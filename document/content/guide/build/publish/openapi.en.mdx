...
description: Access gptGO app via API
---

import { Alert } from '@/components/docs/Alert';

In gptGO, the API entry under Publish Channels shows **API Keys** available to the current signed-in member. API Keys are member credentials for OpenAPI calls and are no longer created as app-scoped keys.
