...
description: gptGO chat input guide
---
...
You can configure the question list directly in gptGO or provide a custom API endpoint.
...
Where `appId` is the app ID and `searchKey` is the search keyword (max 50 characters).
