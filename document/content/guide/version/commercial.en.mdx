---
title: 'gptGO Commercial Edition'
description: 'gptGO Commercial Edition overview'
---
...
gptGO Commercial Edition is an enhanced version built on top of the Community Edition with additional exclusive features. Simply install the commercial image and configure the internal network address on your existing Community Edition setup to get started.
...
gptGO Commercial Edition offers 3 pricing models based on deployment type. Below are the common details for each. If you have further questions,{' '}<CommercialContactDialog
  label="contact us"
  title="Contact gptGO"
...
| Self-hosted                       | 1. Free upgrade support for 6 versions.                                               | Within 14 days | [Contact us for pricing](https://github.com/zeroven0205-spec/)                                                                                     |

<Alert icon="🤖" context="success">
  - "6 versions of upgrade support" means the gptGO team assists with 6 upgrades — not that the
