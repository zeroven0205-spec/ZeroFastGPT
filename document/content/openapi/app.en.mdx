...
```bash
curl --location --request GET 'https://github.com/zeroven0205-spec/' \
...
```bash
curl --location --request POST 'https://github.com/zeroven0205-spec/' \
--header 'Authorization: Bearer apikey' \
...
- appTimespan: App data timespan //day|week|month|quarter
