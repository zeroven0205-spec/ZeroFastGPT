...
description: gptGO OpenAPI Dataset API
---
...
--header 'Content-Type: application/json' \
--data-raw '{
    "link":"https://github.com/zeroven0205-spec/",
    "datasetId":"6593e137231a2be9c5603ba7",
    "parentId": null,
...
--header 'Content-Type: application/json' \
--data-raw '{
    "externalFileUrl":"https://image.xxxxx.com/gptgo-dev/%E6%91%82.pdf",
    "externalFileId":"1111",
  ...
  "data": {
    "list": [
      ...
      },
      {
        ...
        "type": "link",
        "name": "快速上手 | FastGPT",
        "rawLink": "https://github.com/zeroven0205-spec/",
...
Each request can push up to 200 data groups. gptGO automatically creates the processing usage record, so you do not need to provide `billId`.
